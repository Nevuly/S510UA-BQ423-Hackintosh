 ...
 *
 * Disassembly of iASLKklOvz.aml, Sun Dec 22 01:24:19 2019
 *
...
DefinitionBlock ("", "SSDT", 2, "hack", "fan", 0x00000000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.ST98, MethodObj)    // 1 Arguments (from opcode)
    ...
    Device (SMCD)
    {
        ...
        Method (FCPU, 0, NotSerialized)
        {
            ...
            Else
            {
                ...
                {
                    Store (Local2, FLST)
                    \_SB.PCI0.LPCB.EC0.ST98 (DerefOf (Index (FTA2, Local2)))
                    Store (Zero, FCNT)
                }
            }
